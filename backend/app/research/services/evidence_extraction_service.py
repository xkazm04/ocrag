...
class QualityFilter:
    ...
    # Words that indicate vague or uncertain claims
    VAGUE_INDICATORS = [
...
class EvidenceExtractionService:
    ...
    async def _get_topic_name(self, topic_id: UUID) -> Optional[str]:
        ...
        try:
            ...
            logger.warning("Topic lookup failed for topic_id=%s", topic_id)
            return None
...
Avoid vague or general statements."""
        ...
        try:
            ...
            logger.warning("Finding extraction via LLM failed")
    ...
    async def _search_web_context(
        ...
        try:
            ...
            logger.debug("Web context search failed for finding")
            return None, []
    ...
    async def _get_existing_claims(self, topic_id: UUID) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning("Failed to retrieve existing claims for topic_id=%s", topic_id)
            return []
...
{{
    ...
    "reasoning": "brief explanation"
            ...
            try:
                ...
                logger.info("Deduplication LLM failed, defaulting to POST")
                finding["action"] = "POST"
...
Return as JSON array."""
        ...
        try:
            ...
            logger.debug("Perspective analysis failed for finding")
    ...
    async def _save_extraction_record(
        ...
        try:
            ...
            logger.warning("Failed to save extraction record: %s", e)
